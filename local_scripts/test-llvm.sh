...
nohup ../tea-jsouffle/build/install/tea-jsouffle/bin/tea-jsouffle -p 10002 -d ${outdir} -b souffle_itv_new \
  ...
  -A simplify=../tea-absdomain/src/main/dist/souffle-scripts/simplify_llvm_cfg.dl \
  -A reach=../tea-absdomain/src/main/dist/souffle-scripts/reachable.dl \
  -A itv=../tea-absdomain/src/main/dist/souffle-scripts/cwe_interval.dl \
  -A heap=../tea-absdomain/src/main/dist/souffle-scripts/cwe_heap.dl \
  -A alias=../tea-absdomain/src/main/dist/souffle-scripts/alias.dl \
