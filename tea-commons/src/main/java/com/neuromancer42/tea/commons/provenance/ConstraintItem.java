...
public class ConstraintItem {
  // TODO(rg): Why are signs not in the tuples?
	...
	private final RawTuple[] subTuples;
	...
	public ConstraintItem(
			int ruleId,
			RawTuple headTuple, List<RawTuple> subTuples,
		...
		this.subTuples = subTuples.toArray(new RawTuple[0]);
	...
	public RawTuple getHeadTuple() {
		return headTuple;
	}

	public List<RawTuple> getSubTuples() {
